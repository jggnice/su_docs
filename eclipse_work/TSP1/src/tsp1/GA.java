...
public class GA
{
	 ...
	 * @throws IOException
	 */
	private void init(URL fileurl) throws IOException
	{
		// 读取数据
		int[] x;
		int[] y;
	...
	public static void main(String[] args) throws IOException
	{
		...
		GA ga = new GA(30, 52, 1000, 0.8f, 0.9f);
		File f1 = new File("1.txt");
		PrintWriter p = new PrintWriter(f1);

		if (null == GA.class.getResource("att48.txt"))
			return;
		ga.init(GA.class.getResource("att48.txt"));
		ga.solve();
	}
