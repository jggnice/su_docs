...
public class ImageAudioAnimation1 extends JApplet {
	...
	private JComboBox<?> jcboNations = new JComboBox<Object>(new Object[] {
			"Denmark", "Germany", "China", "India", "Norway", "UK", "US" });

	public ImageAudioAnimation1() throws MalformedURLException {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		ImageAudioAnimation1 applet = new ImageAudioAnimation1();
		applet.init();
