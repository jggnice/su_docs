...
@SuppressWarnings("serial")
class AHuaRongRoad extends JPanel
		implements
			MouseListener,
			KeyListener,
			ActionListener
{
	...
	public AHuaRongRoad(int framewidth)
	{³¤±ß = framewidth;
	¶Ì±ß = ³¤±ß / 2;
	relative_left_bound = ¶Ì±ß + dx - 1;
		ac = Applet.newAudioClip(this.getClass().getResource(
				"audio/china.mid"));
		ac.play();
		init();
