...
public class PlayListUI extends MainUI {
	...
	private void initTextPanel() {
		...
		currentPlayLabel.setText("Current Play :");
		if (null != playLists && playLists.size() > 0) {
			totalValueLabel.setText(String.valueOf(playLists.size()));
		} else {
	...
	public void setcurrentPlaySongNameLabel(String songName) {
		if (null != playLists && playLists.size() > 0 && playing) {
	...
	private void initTablePanel() {
		...
		if (null != playLists && playLists.size() > 0) {
			objects = new Object[playLists.size()][6];
	...
	public void playButtonOperation() {
	...
	private void removeButtonOperation() {
		...
		int option = JOptionPane.showConfirmDialog(PlayListUI.this, Common.CONFIM_REMOVE_SONG + name + Common.BLANK + Common.QUESTION_MARK, Common.CONFIM_REMOVE,
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(GroupLayout.Alignment.LEADING)
										...
										.addComponent(tablePanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap().addComponent(buttonPanel, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addGap(0, 0, 0)
						.addComponent(tablePanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGap(0, 0, 0)
						.addComponent(textPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addContainerGap()));
	...
	private void textPanelLayout() {
		...
		textPanelLayout.setHorizontalGroup(textPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				textPanelLayout
						.createSequentialGroup()
						.addContainerGap()
						.addGroup(
								textPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
										.addComponent(currentPlayLabel, GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
						...
						.addGroup(
								textPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
										.addComponent(currentPlaySongNameLabel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(totalValueLabel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addContainerGap()));
		textPanelLayout.setVerticalGroup(textPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				textPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(textPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(currentPlayLabel).addComponent(currentPlaySongNameLabel))
						.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(textPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(totalLabel).addComponent(totalValueLabel))
	...
	private void tablePanelLayout() {
		...
		tablePanelLayout.setHorizontalGroup(tablePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				tablePanelLayout.createSequentialGroup().addContainerGap().addComponent(tableScrollPane, GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE).addContainerGap()));
		tablePanelLayout.setVerticalGroup(tablePanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(tableScrollPane, GroupLayout.DEFAULT_SIZE, 439,
				Short.MAX_VALUE));
	}
	...
	private void buttonPanelLayout() {
		...
		buttonPanelLayout.setHorizontalGroup(buttonPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				buttonPanelLayout.createSequentialGroup().addContainerGap().addComponent(addButton, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18)
						.addComponent(infoTipLable, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(removeButton, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18)
						.addComponent(playButton, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE).addContainerGap()));
						...
						buttonPanelLayout
								...
								.addGroup(
										buttonPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
												.addComponent(removeButton, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE)
												.addComponent(addButton, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE)
												.addComponent(playButton, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE)).addGap(20, 20, 20))
				.addGroup(
						buttonPanelLayout.createSequentialGroup().addContainerGap().addComponent(infoTipLable, GroupLayout.PREFERRED_SIZE, 39, GroupLayout.PREFERRED_SIZE)
								.addGap(31, 31, 31)));
	}
}
