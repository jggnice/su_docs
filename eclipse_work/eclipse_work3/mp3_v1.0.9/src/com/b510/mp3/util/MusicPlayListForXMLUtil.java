...
public class MusicPlayListForXMLUtil {
	...
	private Document generateDocument(List<PlayList> list) {
	...
	public boolean save(List<PlayList> list) {
	...
	public List<PlayList> loadPlayListFromXML() {
		...
		if (file.exists()) {
			try {
				...
				Iterator song = root.elementIterator("song"); song.hasNext();) {
